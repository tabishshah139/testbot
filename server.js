...
if (message.content === '+drop'){
    ...
    var string = `:one: Mega.nz Accounts Drop You Can See Detail About Account by visiting this link 18th September 2020 ( https://direct-link.net/73563/drop ). Official Server ( https://discord.gg/A4XauME ) .`;
   var words = string.split('\n');
    let random = words[Math.floor(Math.random()*words.length)];
      message.author.send("**Join Tabish Gen Official CM** https://discord.gg/A4XauME . You Can Invite FUNZONE BOT At Your Server type +invite.");
     message.author.send({embed: {
