...
if (message.content === '+gen'){
   ...
   var words = string.split('\n');
    let random = words[Math.floor(Math.random()*words.length)];
      message.author.send("**Join Tabish Gen Official CM** https://discord.gg/dY9fDTy .Tutorial About Generating Accounts https://youtu.be/jBILyOwZDtY. You Can Invite Tabish Gen At Your Server type +invite.");
...
message.author.send(":one: Random Drop You Can See Detail About Account by visiting this link 27th january 2020 ( https://link-to.net/41622/dailydrop ). Official Server ( https://discord.gg/dY9fDTy ).");
   }
}); 
