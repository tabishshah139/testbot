...
if (message.content === '+drop'){
    ...
    var string = `:white_check_mark: NordVpn Fresh Accounts Drop 29th October 2020 ( https://anonfiles.com/56Z7M4k0p9/Email_access_txt ). Official Server ( https://discord.gg/ymkUchb ) .`;
   var words = string.split('\n');
    let random = words[Math.floor(Math.random()*words.length)];
      message.author.send("**Join FUN ZONE Official CM** https://discord.gg/ymkUchb . You Can Invite FUNZONE BOT At Your Server type +invite.");
     message.author.send({embed: {
